 ...
 *
 */
public class ConfigurationPanel extends ProMHeaderPanel {
	 ...
	 * @param title
	 */
	public ConfigurationPanel(final String title) {
		super(title);
...
//		installHighlighter(component, target);
		...
		nameLabel.setMinimumSize(new Dimension(400, 20));
		nameLabel.setMaximumSize(new Dimension(400, 1000));
