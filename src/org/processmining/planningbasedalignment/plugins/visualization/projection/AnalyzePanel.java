...
public class AnalyzePanel extends JPanel {
	...
	private static class AnalyzePanelListener extends MouseAdapter {
		...
		private final PlanningBasedReplayResult replayResult;
		private final PluginContext context;

		public AnalyzePanelListener(
				PluginContext context, ProMJGraphPanel panel, PlanningBasedReplayResult replayResult) {
...
//				}
	...
	public AnalyzePanel(PluginContext context, DataPetriNet net, PlanningBasedReplayResult replayResult)
			throws Exception {
